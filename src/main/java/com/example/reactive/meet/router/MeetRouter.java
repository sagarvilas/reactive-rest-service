...
public class MeetRouter {
    ...
    public RouterFunction<ServerResponse> meetRoute(MeetHandler meetHandler) {
        ...
        return RouterFunctions
                .route(RequestPredicates.GET("/meetSequential")
                        .and(RequestPredicates
                                .accept(MediaType.TEXT_PLAIN)), meetHandler::sequential)
                .andRoute(RequestPredicates.GET("/meetParallel")
                        .and(RequestPredicates
                                .accept(MediaType.TEXT_PLAIN)), meetHandler::parallel);
    }
}